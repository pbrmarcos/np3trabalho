...
import { Loader2, CheckCircle2, XCircle, Mail, ExternalLink, Globe, AlertCircle, Settings, FileText, History } from "lucide-react";
import { supabase } from "@/integrations/supabase/client";
import { toast } from "sonner";
import { EmailTemplatesManager, EmailFooterConfig, EmailLogsPage } from "./emails";
...
export default function EmailConfigSection({ settings, onSave, isSaving }: EmailConfigSectionProps) {
  ...
  return (
    <Tabs value={activeSubTab} onValueChange={setActiveSubTab}>
      ...
      <TabsContent value="footer" className="mt-6">
        <EmailFooterConfig settings={settings} onSave={onSave} isSaving={isSaving} />
      </TabsContent>
    </Tabs>
  );
}
